	...
	return (
		<div className="footer-container">
			<div className="footer">
				<h5 style={{color: 'black'}}>Copyright &copy; 2021 Bryan Guilas</h5>
				...
				<a href="https://www.bryanjguilas.com/" target="_blank" rel="noreferrer"><i className="fas fa-id-card fa-2x"/></a>
			</div>
		</div>
	);
};
